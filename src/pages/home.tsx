   ...
   <main className="flex sm:flex-row flex-col justify-around md:w-[760px] lg:w-[900px] font-Tinos mx-auto">
      <div className="flex items-center justify-center">
        ...
        <motion.h1  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0, transition: { delay: 0.2 } }} className="text-5xl font-Tinos-Bold">Hi, im Ali</motion.h1>
        <motion.h2  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0, transition: { delay: 0.3 } }} className="my-1 text-lg text-gray-400">junior FrontEnd Developer</motion.h2>
        <motion.div  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0, transition: { delay: 0.5 } }}  className="my-10 text-lg font-Karla flex items-center justify-between gap-x-6">
                    <Link to={'/projects'}>
      ...
      <motion.div  initial={{ opacity: 0, scale: 0.9 }}
            ...
            <div className="w-65 h-65 mx-auto md:w-90 md:h-90 rounded-full overflow-hidden border-4 border-zinc-500/30 mb-6 hover:scale-105 transition-transform">
