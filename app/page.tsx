  ...
  return (
   <main className="flex justify-around w-[900px] font-Tinos mx-auto">
      ...
      <motion.div  initial={{ opacity: 0, scale: 0.9 }}
            ...
            <div className="w-48 h-48 md:w-90 md:h-90 rounded-full overflow-hidden border-4 border-zinc-500/30 mb-6 hover:scale-105 transition-transform">
                      {/* Placeholder for profile image */}
                      <div className="w-full h-full flex items-center justify-center">
                        <img className="w-full h-full" src={img_Url} alt="" />
                      </div>
              </div>
              <FaCode className="size-20 p-5 absolute -z-10 bottom-1 right-1 border-4 rounded-full  border-zinc-500/30 text-white"/>
      </motion.div>
   </main>
  );
}
